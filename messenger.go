...
// queue is a structure where producers from multiple goroutines can send or broadcast messages to consumers from the
// registered id.
//
// It does not spin up a separate go routine for managing the structure.
